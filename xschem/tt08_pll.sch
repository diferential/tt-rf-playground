...
S {}
E {}
T {Voltage restorer} 1140 -2150 0 0 0.4 0.4 {}
...
lab=FB_POST_DIV}
N 1530 -1880 1530 -1850 {
lab=#net3}
N 1460 -1880 1460 -1850 {
lab=#net4}
N 1600 -1880 1600 -1850 {
lab=PLL_OUT}
N 1600 -1820 1600 -1790 {
lab=PLL_OUT}
N 1600 -1850 1600 -1820 {
lab=PLL_OUT}
N 1530 -1850 1530 -1820 {
lab=#net3}
N 1530 -1820 1530 -1790 {
lab=#net3}
N 1600 -1880 1650 -1880 {
lab=PLL_OUT}
...
lab=VSS}
N 1390 -1960 1430 -1960 {
lab=FB_PRE_DIV}
N 1390 -1960 1390 -1880 {
lab=FB_PRE_DIV}
N 1390 -2050 1390 -1960 {
lab=FB_PRE_DIV}
...
C {devices/lab_pin.sym} 1390 -1880 2 1 {name=p20 sig_type=std_logic lab=FB_PRE_DIV
}
...
C {devices/lab_pin.sym} 1090 -2050 2 1 {name=p13 sig_type=std_logic lab=AB1
}
...
C {pll_inv1.sym} 1440 -1880 0 0 {name=x18 VSS=VSS VDD=VDPWR}
C {devices/lab_pin.sym} 1650 -1880 0 1 {name=p16 sig_type=std_logic lab=PLL_OUT
}
...
C {pll_inv1.sym} 1510 -1880 0 0 {name=x2 VSS=VSS VDD=VDPWR}
C {pll_inv1.sym} 1510 -1850 0 0 {name=x9 VSS=VSS VDD=VDPWR}
C {pll_inv1.sym} 1580 -1880 0 0 {name=x16 VSS=VSS VDD=VDPWR}
C {pll_inv1.sym} 1580 -1850 0 0 {name=x19 VSS=VSS VDD=VDPWR}
C {pll_inv1.sym} 1580 -1820 0 0 {name=x21 VSS=VSS VDD=VDPWR}
C {pll_inv1.sym} 1580 -1790 0 0 {name=x22 VSS=VSS VDD=VDPWR}
...
C {pll_invresfb.sym} 1240 -2050 0 0 {name=x25}
