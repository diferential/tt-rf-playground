...
VUP UP   0 pulse 0 1.8 30.000n 1p 1p 500p 10n
VUPB UPB 0 pulse 1.8 0 30.000n 1p 1p 500p 10n
VDN DN   0 pulse 0 1.8 30.005n 1p 1p 10p 10n
VDNB DNB 0 pulse 1.8 0 30.005n 1p 1p 10p 10n
VCK  CK  0 pulse 0 1.8 32.000n 1p 1p 100p 10n
VCKB CKB 0 pulse 1.8 0 32.000n 1p 1p 100p 10n
VPRE_CMD PRE_CMD 0 pulse 1.8 0 2.5n 1p 1p 30n 10000n
.control
  repeat 1
    save all
    tran 4p 300n
    remzerovec
    write tb_pll_cp_charlie.raw
    set appendwrite
    reset
    end
.endc
...
C {pll_cp_charlie.sym} 1710 -1000 0 0 {name=x1}
...
device=resistor
m=1}
C {pll_cp_charlie.sym} 1710 -820 0 0 {name=x2}
